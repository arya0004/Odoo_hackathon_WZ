...
// change password for logged-in user (userAuth must set req.user)
export const changePassword = async (req, res) => {
  try {
    // userAuth middleware should have set req.user = { id: ..., role: ..., ... }
    const userId = req.user?.id;
    ...
    // clear must_change_password flag (if you added it)
    if (Object.prototype.hasOwnProperty.call(user, "must_change_password")) {
